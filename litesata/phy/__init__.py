...
class LiteSATAPHY(Module):
    ...
    """
    def __init__(self, device, refclk, pads, revision, clk_freq, data_width=16):
        self.refclk   = refclk
        self.pads     = pads
        ...
        if device[:4] == "xc7k": # Kintex 7
            ...
            self.submodules.crg = K7LiteSATAPHYCRG(refclk, pads, self.phy, revision, clk_freq)
            ...
            self.submodules.crg = A7LiteSATAPHYCRG(refclk, pads, self.phy, revision, clk_freq)
        else:
