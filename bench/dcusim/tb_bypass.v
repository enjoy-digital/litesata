// Auto-generated DCUA testbench (bypass mode) - LiteSATA ECP5 OOB investigation.
`timescale 1ps/1ps
module tb_bypass;
  ...
  // D10.2-style TX content (raw 10b 0101.. symbols).
  always @(posedge tx_pclk) begin
    tx_d <= {2'b00, 10'b0101010101, 2'b00, 10'b0101010101};
  end
  ...
  initial begin
    $dumpfile("tb_bypass.vcd");
    $dumpvars(1, tb_bypass);
